...
class QuestionnairePostTest(UserMixin, db.Model):#userMixiin c'est pr traiter lesmethodes relatives aux login et l'autre pour les DB
    __tablename__ = 'QuestionnairePostTest' 
    ...
    rel_Evaluation = relationship("Evaluation", backref='QuestionnairePostTest', uselist=False)
    ...
    def __init__(self):
        print("constructeur vide questionnaire posttest")
